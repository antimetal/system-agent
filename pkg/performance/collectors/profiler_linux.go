...
func (c *ProfilerCollector) attachPerfEvent(prog *ebpf.Program, cpu int) (link.Link, error) {
	...
	// In cilium/ebpf, we use AttachRawLink for perf events
...
// Linux-specific implementation of onlineCPUs
